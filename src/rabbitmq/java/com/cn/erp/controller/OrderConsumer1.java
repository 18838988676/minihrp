    ...
    public void handleMessage(Message message,Channel channel) throws IOException {
        try {
          ...
          //  System.out.println("OrderConsumer {} handleMessage :"+message);
            ...
            /**       
             * 第一个参数 deliveryTag：
             * 就是接受的消息的deliveryTag,可以通过msg.getMessageProperties().getDeliveryTag()获得            * 
 ...
 * channel.basicAck(message.getMessageProperties().getDeliveryTag(), false);** 
 * ack返回false，并重新回到队列* channel.basicNack(message.getMessageProperties().getDeliveryTag(), false, true);** 
